...
public enum TypeOfBuilding {
    ...
    private TypeOfBuilding(int hp, int length, int width, int workerInUse,String buildingName,Texture texture,int cost,Resources resourceNeeded,int resourceAmount) {
        this.hp=hp;
        this.length=length;
        this.width=width;
