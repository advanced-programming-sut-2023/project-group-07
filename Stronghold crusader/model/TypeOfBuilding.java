...
public enum TypeOfBuilding {
    ...
    APPLE_ORCHARD(200, 9, 9, 1, "apple orchard", Texture.MEADOW, 0, Resources.WOOD, 5, "converting resources",
            NonMilitaryTypes.FARMER, 4),
    DIARY_FARMER(200, 9, 9, 1, "diary farmer", Texture.MEADOW, 0, Resources.WOOD, 10, "converting resources",
            NonMilitaryTypes.FARMER, 4),
    WHEAT_FARMER(200, 9, 9, 1, "wheat farmer", Texture.MEADOW, 0, Resources.WOOD, 15, "converting resources",
            NonMilitaryTypes.FARMER, 4),
    HOPS_FARMER(200, 9, 9, 1, "hops farmer", Texture.MEADOW, 0, Resources.WOOD, 15, "converting resources",
            NonMilitaryTypes.FARMER, 4),
    HUNTER_POST(200, 9, 9, 1, "hunter post", null, 0, Resources.WOOD, 10, "converting resources",
