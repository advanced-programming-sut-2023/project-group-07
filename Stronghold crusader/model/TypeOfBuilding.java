...
public enum TypeOfBuilding {
    ...
    IRON_MINE(300, 4, 4, 2, "iron mine", Texture.IRON, 0, Resources.WOOD, 20,"converting resources",NonMilitaryTypes.IRON_MINER,4),
    OX_TETHER(100, 2, 2, 1, "ox tether", null, 0, Resources.WOOD, 5,"building",NonMilitaryTypes.STONE_MASON,1),
    QUARRY(350, 6, 6, 3, "quarry", Texture.STONE, 0, Resources.WOOD, 20,"converting resources",NonMilitaryTypes.STONE_MASON,6),
    MARKET(200, 5, 5, 0, "market", null, 0, Resources.WOOD, 5,"building",null,5),
    PITCH_RIG(200, 4, 4, 2, "pitch rig", Texture.OIL, 0, Resources.WOOD, 20,"converting resources",NonMilitaryTypes.PITCH_DIGGER,0),
    ...
    WOODCUTTER(150, 3, 3, 1, "woodcutter", null, 0, Resources.WOOD, 3,"converting resources",NonMilitaryTypes.WOODCUTTER,3),
    ...
    ARMOURER(500, 4, 4, 1, "armourer", null, 100, Resources.WOOD, 20,"converting resources",NonMilitaryTypes.ARMOURER,5),
    BLACKSMITH(500, 4, 4, 1, "blacksmith", null, 200, Resources.WOOD, 20,"converting resources",NonMilitaryTypes.BLACKSMITH,5),
    POLETURNER(500, 4, 4, 1, "poleturner", null, 100, Resources.WOOD, 10,"converting resources",NonMilitaryTypes.POLETURNER,5),
    FLETCHER(500, 4, 4, 1, "fletcher", null, 100, Resources.WOOD, 20,"converting resources",NonMilitaryTypes.FLETCHER,5),
    ...
    APPLE_ORCHARD(200, 9, 9, 1, "apple orchard", Texture.MEADOW, 0, Resources.WOOD, 5,"converting resources",NonMilitaryTypes.FARMER,4),
    DIARY_FARMER(200, 9, 9, 1, "diary farmer", Texture.MEADOW, 0, Resources.WOOD, 10,"converting resources",NonMilitaryTypes.FARMER,4),
    WHEAT_FARMER(200, 9, 9, 1, "wheat farmer", Texture.MEADOW, 0, Resources.WOOD, 15,"converting resources",NonMilitaryTypes.FARMER,4),
    HOPS_FARMER(200, 9, 9, 1, "hops farmer", Texture.MEADOW, 0, Resources.WOOD, 15,"converting resources",NonMilitaryTypes.FARMER,4),
    HUNTER_POST(200, 9, 9, 1, "hunter post", null, 0, Resources.WOOD, 10,"converting resources",NonMilitaryTypes.HUNTER,4),
    ...
    private TypeOfBuilding(int hp, int length, int width, int workerInUse, String buildingName, Texture texture,
            int cost, Resources resourceNeeded, int resourceAmount,String type,NonMilitaryTypes workerType,int height) {
        this.hp = hp;
        this.length = length;
        this.width = width;
